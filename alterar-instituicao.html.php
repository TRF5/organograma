    ...
    <main id="Inicio_Conteudo" class="container">
        ...
        <?php
            ...
            if ($nome_instituicao) {
                ...
                if (alterarInstituicao($nome_instituicao, $sigla_nova) ==  TRUE) {
        ...
        <form class="formulario" method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control campo" id="instituicao" name="instituicao" value="<?php echo $instituicao?>" placeholder="Ex.: Tribunal Regional Federal da 5ª Região">
            </div>
            <div class="mb-3">
                <label for="sigla" class="form-label cargo ">Sigla</label>
                <input type="text" class="form-control campo" id="sigla" value="<?php echo $sigla?>" name="sigla"placeholder="Ex.: TRF5">
            </div>
            <div class="parte-inferior-formulario">
                <button type="submit" title="Atualizar instituição" class="btn botao btn-primary">Atualizar</button>
                <button type="button" id="limpar" class="btn botao btn-outline-primary"
                    title="Limpar campos do formulário ">Limpar</button>
                 <a id="cancelar" class="btn botao btn-danger"
                title="Cancelar alteração e voltar para listagem de Instituições" href="/organograma-atualizado/instituicao.php">Cancelar</a>
            </div>
